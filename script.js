...
function renderTasks(tasks) {
    ...
    tasks.forEach((task) => {
        ...
        updateButton.addEventListener("click", () => onClickUpdateTask(task.id, task.completed));
    });
}
...
function searchTask() {
    ...
    tableBody.appendChild(tableRow);
        ...
        // Search button
        const searchButton = document.getElementById("searchButtonById");
        const searchInput = document.getElementById("searchBar");
        searchButton.addEventListener("click", () => {
            indexTaskById(searchInput.value)
        });

function indexTaskById(Id) {
